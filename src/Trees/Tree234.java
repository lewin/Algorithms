...
public class Tree234 {
  static class Tree234Node {
    ...
    protected Tree234Node ejectMiddle() {
      ...
      if (parent == null)
        parent = new Tree234Node();
      Tree234Node c1 = new Tree234Node(parent, key1);
      c1.updateChild(1, child1);
      c1.updateChild(2, child2);
      Tree234Node c2 = new Tree234Node(parent, key3);
      c2.updateChild(1, child3);
      c2.updateChild(2, child4);

      int pos = parent.addKey(key2);
      if (pos <= 2)
        parent.updateChild(4, parent.child3);
      if (pos <= 1)
        parent.updateChild(3, parent.child2);
      parent.updateChild(pos, c1);
      parent.updateChild(pos + 1, c2);
  ...
  public void insert(int key) {
    ...
    Tree234Node cur;
    for (cur = root; cur.keys == 3 || cur.child1 != null; cur =
        (cur.keys == 3 ? cur.ejectMiddle() : cur).next(key));
    cur.addKey(key);
